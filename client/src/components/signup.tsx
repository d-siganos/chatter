...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    let passwordRep = passwordRepRef.current?.value;
    ...
    if (password?.length < 6) {
      return setError("Password must be over 6 characters long");
    }
          ...
          <div className="md:flex md:items-center md:justify-center w-full sm:w-auto md:h-full xl:w-2/5 p-8 md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white">
            <div className="max-w-md w-full space-y-8">
              <div className="text-center">
                <h2 className="mt-6 text-3xl font-bold text-gray-900">Hello there!</h2>
                <p className="mt-2 text-sm text-gray-500">Let's create your account</p>
              </div>
              <div className="flex flex-row justify-center items-center space-x-3">
                <FcGoogle className="w-11 h-11 items-center justify-center inline-flex font-bold text-lg hover:shadow-lg cursor-pointer transition ease-in duration-100" />
              </div>
              ...
              <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="mt-8 content-center">
                  ...
                  <input
                    ...
                    type="password" ref={passwordRef} placeholder="Enter your password" />
                </div>
                <div className="mt-8 content-center">
                  <label className="ml-3 text-sm font-bold text-gray-700 tracking-wide">
                    Password
                  ...
                  <input
                    className="w-full content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-indigo-500"
                    type="password" ref={passwordRepRef} placeholder="Repeat your password" />
                </div>
                <div>
