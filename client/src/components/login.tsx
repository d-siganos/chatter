          ...
          <div className="md:flex md:items-center md:justify-center w-full sm:w-auto md:h-full xl:w-2/5 p-8 md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white">
            <div className="max-w-md w-full space-y-8">
              ...
              <div className="flex flex-row justify-center items-center space-x-3">
                <FcGoogle className="w-11 h-11 items-center justify-center inline-flex font-bold text-lg hover:shadow-lg cursor-pointer transition ease-in duration-100" onClick={googleAuth} />
              </div>
              ...
              <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-sm">
                    <Link to="/password-reset" className="text-indigo-400 hover:text-blue-500 transition ease-in duration-300">
